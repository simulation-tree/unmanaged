...
{
    /// <summary>
    /// Container of up to 31 extended ASCII <see cref="char"/> values.
    /// </summary>
    [SkipLocalsInit]
    [StructLayout(LayoutKind.Sequential, Size = 32)]
    public unsafe struct ASCIIText32 : IEquatable<ASCIIText32>
    {
        /// <summary>
        ...
        /// </summary>
        public ASCIIText32(string text)
        {
        ...
        /// Creates a new instance from the given <paramref name="text"/>.
        /// </summary>
        public ASCIIText32(ReadOnlySpan<char> text)
        {
            ThrowIfLengthExceedsCapacity(text.Length);
        ...
        /// </summary>
        public ASCIIText32(IEnumerable<char> text)
        {
            int index = 0;
        ...
        /// </summary>
        public ASCIIText32(ReadOnlySpan<byte> utf8Bytes)
        {
            int index = 0;
        ...
        /// <para>
        /// Reads until reaching a null terminator, or 31 characters.
        /// </para>
        /// </summary>
        public ASCIIText32(void* utf8Bytes)
        {
        ...
        /// </summary>
        public readonly ASCIIText32 Slice(int start, int length)
        {
            ThrowIfIndexOutOfRange(start);
            ThrowIfLengthExceedsCapacity(start + length);

            ASCIIText32 result = default;
            for (int i = 0; i < length; i++)
            {
        ...
        /// </summary>
        public readonly ASCIIText32 Slice(int start)
        {
        ...
        /// Checks if this string contains the given text.
        /// </summary>
        public readonly bool Contains(ASCIIText32 text)
        {
            for (int i = 0; i < length; i++)
            {
                if (characters[i] == text[0])
        ...
        /// <para>May throw <see cref="ArgumentException"/> if not contained.</para>
        /// </summary>
        public readonly int IndexOf(ASCIIText32 text)
        {
            for (int i = 0; i < length; i++)
            {
                if (characters[i] == text[0])
        ...
        /// </summary>
        /// <returns><c>true</c> if found.</returns>
        public readonly bool TryIndexOf(ASCIIText32 text, out int index)
        {
            for (int i = 0; i < length; i++)
            {
                if (characters[i] == text[0])
        ...
        /// <para>May throw <see cref="ArgumentException"/> if not contained.</para>
        /// </summary>
        public readonly int LastIndexOf(ASCIIText32 text)
        {
            int thisLength = Length;
            for (int i = thisLength - 1; i >= 0; i--)
            {
        ...
        /// </summary>
        /// <returns><c>true</c> if found.</returns>
        public readonly bool TryLastIndexOf(ASCIIText32 text, out int index)
        {
            int thisLength = Length;
            for (int i = thisLength - 1; i >= 0; i--)
            {
        ...
        /// Checks if this string starts with the given text.
        /// </summary>
        public readonly bool StartsWith(ASCIIText32 text)
        {
            if (text.length > length)
            {
                return false;
        ...
        /// Checks if this string ends with the given text.
        /// </summary>
        public readonly bool EndsWith(ASCIIText32 text)
        {
            if (text.length > length)
            {
                return false;
        ...
        /// Appends a text span to the end of this string.
        /// </summary>
        public void Append(ASCIIText32 text)
        {
        ...
        /// Inserts a text span at the given index.
        /// </summary>
        public void Insert(int index, ASCIIText32 text)
        {
            int textLength = text.Length;
            ThrowIfLengthExceedsCapacity(length + textLength);
        ...
        /// </summary>
        /// <returns><c>true</c> if a replacement was done.</returns>
        public bool TryReplace(ASCIIText32 oldValue, ASCIIText32 newValue)
        {
            for (int i = 0; i < length; i++)
            {
                if (characters[i] == oldValue[0])
        ...
        /// <inheritdoc/>
        public readonly bool Equals(ASCIIText32 other)
        {
        ...
        {
            return obj is ASCIIText32 other && Equals(other);
        }
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText32(string text)
        {
            return new(text);
        }

        /// <inheritdoc/>
        public static implicit operator ASCIIText32(Span<char> text)
        {
            return new(text);
        }

        /// <inheritdoc/>
        public static implicit operator ASCIIText32(ReadOnlySpan<char> text)
        {
            return new(text);
        }

        /// <inheritdoc/>
        public static implicit operator ASCIIText16(ASCIIText32 value)
        {
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText8(ASCIIText32 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static explicit operator ASCIIText64(ASCIIText32 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static explicit operator ASCIIText128(ASCIIText32 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static explicit operator ASCIIText256(ASCIIText32 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static explicit operator ASCIIText512(ASCIIText32 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static explicit operator ASCIIText1024(ASCIIText32 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static bool operator ==(ASCIIText32 a, ASCIIText32 b)
        {
            return a.Equals(b);
        }
