...
{
    /// <summary>
    /// Container of up to 1022 extended ASCII <see cref="char"/> values.
    /// </summary>
    [SkipLocalsInit]
    [StructLayout(LayoutKind.Sequential, Size = Capacity + 2)]
    public struct ASCIIText1024 : IEquatable<ASCIIText1024>
    {
        /// <summary>
        /// Maximum number of characters that can be stored.
        /// </summary>
        public const int Capacity = 1022;
        ...
        /// </summary>
        public ASCIIText1024(string text)
        {
        ...
        /// Creates a new instance from the given <paramref name="text"/>.
        /// </summary>
        public ASCIIText1024(ReadOnlySpan<char> text)
        {
            ThrowIfLengthExceedsCapacity(text.Length);
        ...
        /// </summary>
        public ASCIIText1024(IEnumerable<char> text)
        {
            int index = 0;
        ...
        /// </summary>
        public ASCIIText1024(ReadOnlySpan<byte> utf8Bytes)
        {
            int index = 0;
        ...
        /// <para>
        /// Reads until reaching a null terminator, or 1022 characters.
        /// </para>
        /// </summary>
        public unsafe ASCIIText1024(void* utf8Bytes)
        {
        ...
        /// </summary>
        public readonly ASCIIText1024 Slice(int start, int length)
        {
            ThrowIfIndexOutOfRange(start);
            ThrowIfLengthExceedsCapacity(start + length);

            ASCIIText1024 result = default;
            for (int i = 0; i < length; i++)
            {
        ...
        /// </summary>
        public readonly ASCIIText1024 Slice(int start)
        {
        ...
        /// Checks if this string contains the given text.
        /// </summary>
        public readonly bool Contains(ASCIIText1024 text)
        {
            for (int i = 0; i < length; i++)
            {
                if (characters[i] == text[0])
        ...
        /// <para>May throw <see cref="ArgumentException"/> if not contained.</para>
        /// </summary>
        public readonly int IndexOf(ASCIIText1024 text)
        {
            for (int i = 0; i < length; i++)
            {
                if (characters[i] == text[0])
        ...
        /// </summary>
        /// <returns><c>true</c> if found.</returns>
        public readonly bool TryIndexOf(ASCIIText1024 text, out int index)
        {
            for (int i = 0; i < length; i++)
            {
                if (characters[i] == text[0])
        ...
        /// <para>May throw <see cref="ArgumentException"/> if not contained.</para>
        /// </summary>
        public readonly int LastIndexOf(ASCIIText1024 text)
        {
            int thisLength = Length;
            for (int i = thisLength - 1; i >= 0; i--)
            {
        ...
        /// </summary>
        /// <returns><c>true</c> if found.</returns>
        public readonly bool TryLastIndexOf(ASCIIText1024 text, out int index)
        {
            int thisLength = Length;
            for (int i = thisLength - 1; i >= 0; i--)
            {
        ...
        /// Checks if this string starts with the given text.
        /// </summary>
        public readonly bool StartsWith(ASCIIText1024 text)
        {
            if (text.length > length)
            {
                return false;
        ...
        /// Checks if this string ends with the given text.
        /// </summary>
        public readonly bool EndsWith(ASCIIText1024 text)
        {
            if (text.length > length)
            {
                return false;
        ...
        public void Append<T>(T formattable) where T : ISpanFormattable
        {
            ...
            length = (ushort)(length + charsWritten);
        }
#else
        public void Append<T>(T formattable) where T : IFormattable
        {
            ...
            length = (ushort)(length + text.Length);
        }
#endif
        ...
        /// Appends a text span to the end of this string.
        /// </summary>
        public void Append(ASCIIText1024 text)
        {
            ...
            length = (ushort)(length + textLength);
        }
        ...
        public void RemoveRange(int start, int length)
        {
            ...
            this.length = (ushort)(thisLength - length);
        }
        ...
        /// Inserts a text span at the given index.
        /// </summary>
        public void Insert(int index, ASCIIText1024 text)
        {
            int textLength = text.Length;
            ThrowIfLengthExceedsCapacity(length + textLength);
                ...
                if (characters[i] == oldValue[0])
                {
                    ...
                    if (found)
                    {
                        ...
                        else
                        {
                            ...
                            length = (ushort)(length + difference);
                        }
        ...
        /// </summary>
        /// <returns><c>true</c> if a replacement was done.</returns>
        public bool TryReplace(ASCIIText1024 oldValue, ASCIIText1024 newValue)
        {
            for (int i = 0; i < length; i++)
            {
                if (characters[i] == oldValue[0])
        ...
        /// <inheritdoc/>
        public readonly bool Equals(ASCIIText1024 other)
        {
        ...
        {
            return obj is ASCIIText1024 other && Equals(other);
        }
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText1024(string text)
        {
            return new(text);
        }

        /// <inheritdoc/>
        public static implicit operator ASCIIText1024(Span<char> text)
        {
            return new(text);
        }

        /// <inheritdoc/>
        public static implicit operator ASCIIText1024(ReadOnlySpan<char> text)
        {
            return new(text);
        }

        /// <inheritdoc/>
        public static implicit operator ASCIIText512(ASCIIText1024 value)
        {
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText256(ASCIIText1024 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText128(ASCIIText1024 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText64(ASCIIText1024 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText32(ASCIIText1024 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText16(ASCIIText1024 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText8(ASCIIText1024 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static bool operator ==(ASCIIText1024 a, ASCIIText1024 b)
        {
            return a.Equals(b);
        }
