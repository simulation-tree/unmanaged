...
{
    /// <summary>
    /// Container of up to 510 extended ASCII <see cref="char"/> values.
    /// </summary>
    [SkipLocalsInit]
    [StructLayout(LayoutKind.Sequential, Size = Capacity + 2)]
    public struct ASCIIText512 : IEquatable<ASCIIText512>
    {
        /// <summary>
        /// Maximum number of characters that can be stored.
        /// </summary>
        public const int Capacity = 510;
        ...
        /// </summary>
        public ASCIIText512(string text)
        {
        ...
        /// Creates a new instance from the given <paramref name="text"/>.
        /// </summary>
        public ASCIIText512(ReadOnlySpan<char> text)
        {
            ThrowIfLengthExceedsCapacity(text.Length);
        ...
        /// </summary>
        public ASCIIText512(IEnumerable<char> text)
        {
            int index = 0;
        ...
        /// </summary>
        public ASCIIText512(ReadOnlySpan<byte> utf8Bytes)
        {
            int index = 0;
        ...
        /// <para>
        /// Reads until reaching a null terminator, or 510 characters.
        /// </para>
        /// </summary>
        public unsafe ASCIIText512(void* utf8Bytes)
        {
        ...
        /// </summary>
        public readonly ASCIIText512 Slice(int start, int length)
        {
            ThrowIfIndexOutOfRange(start);
            ThrowIfLengthExceedsCapacity(start + length);

            ASCIIText512 result = default;
            for (int i = 0; i < length; i++)
            {
        ...
        /// </summary>
        public readonly ASCIIText512 Slice(int start)
        {
        ...
        /// Checks if this string contains the given text.
        /// </summary>
        public readonly bool Contains(ASCIIText512 text)
        {
            for (int i = 0; i < length; i++)
            {
                if (characters[i] == text[0])
        ...
        /// <para>May throw <see cref="ArgumentException"/> if not contained.</para>
        /// </summary>
        public readonly int IndexOf(ASCIIText512 text)
        {
            for (int i = 0; i < length; i++)
            {
                if (characters[i] == text[0])
        ...
        /// </summary>
        /// <returns><c>true</c> if found.</returns>
        public readonly bool TryIndexOf(ASCIIText512 text, out int index)
        {
            for (int i = 0; i < length; i++)
            {
                if (characters[i] == text[0])
        ...
        /// <para>May throw <see cref="ArgumentException"/> if not contained.</para>
        /// </summary>
        public readonly int LastIndexOf(ASCIIText512 text)
        {
            int thisLength = Length;
            for (int i = thisLength - 1; i >= 0; i--)
            {
        ...
        /// </summary>
        /// <returns><c>true</c> if found.</returns>
        public readonly bool TryLastIndexOf(ASCIIText512 text, out int index)
        {
            int thisLength = Length;
            for (int i = thisLength - 1; i >= 0; i--)
            {
        ...
        /// Checks if this string starts with the given text.
        /// </summary>
        public readonly bool StartsWith(ASCIIText512 text)
        {
            if (text.length > length)
            {
                return false;
        ...
        /// Checks if this string ends with the given text.
        /// </summary>
        public readonly bool EndsWith(ASCIIText512 text)
        {
            if (text.length > length)
            {
                return false;
        ...
        /// Appends a text span to the end of this string.
        /// </summary>
        public void Append(ASCIIText512 text)
        {
        ...
        /// Inserts a text span at the given index.
        /// </summary>
        public void Insert(int index, ASCIIText512 text)
        {
            int textLength = text.Length;
            ThrowIfLengthExceedsCapacity(length + textLength);
        ...
        /// </summary>
        /// <returns><c>true</c> if a replacement was done.</returns>
        public bool TryReplace(ASCIIText512 oldValue, ASCIIText512 newValue)
        {
            for (int i = 0; i < length; i++)
            {
                if (characters[i] == oldValue[0])
        ...
        /// <inheritdoc/>
        public readonly bool Equals(ASCIIText512 other)
        {
        ...
        {
            return obj is ASCIIText512 other && Equals(other);
        }
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText512(string text)
        {
            return new(text);
        }

        /// <inheritdoc/>
        public static implicit operator ASCIIText512(Span<char> text)
        {
            return new(text);
        }

        /// <inheritdoc/>
        public static implicit operator ASCIIText512(ReadOnlySpan<char> text)
        {
            return new(text);
        }

        /// <inheritdoc/>
        public static implicit operator ASCIIText256(ASCIIText512 value)
        {
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText128(ASCIIText512 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText64(ASCIIText512 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText32(ASCIIText512 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText16(ASCIIText512 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText8(ASCIIText512 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static explicit operator ASCIIText1024(ASCIIText512 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static bool operator ==(ASCIIText512 a, ASCIIText512 b)
        {
            return a.Equals(b);
        }
