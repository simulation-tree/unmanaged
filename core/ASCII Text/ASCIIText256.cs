...
namespace Unmanaged
{
    ...
    public struct ASCIIText256 : IEquatable<ASCIIText256>
    {
        /// <summary>
        ...
        /// </para>
        /// </summary>
        public unsafe ASCIIText256(void* utf8Bytes)
        {
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText128(ASCIIText256 value)
        {
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText64(ASCIIText256 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText32(ASCIIText256 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText16(ASCIIText256 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static implicit operator ASCIIText8(ASCIIText256 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static explicit operator ASCIIText512(ASCIIText256 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
        ...
        /// <inheritdoc/>
        public static explicit operator ASCIIText1024(ASCIIText256 value)
        {
            Span<char> span = stackalloc char[value.Length];
            value.CopyTo(span);
